...
def run_test_count_positive_sines():
    ...
    # Test 7:
    expected = 2
    actual = count_positive_sines([0, 3.14, 1.57, 4.71, 6.28])
    print()
    print('Test 7 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 1170
    actual = sum_first_n([570, 600, 650, 675, 720], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 88
    actual = sum_first_n([12, 9, 19, 48], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
